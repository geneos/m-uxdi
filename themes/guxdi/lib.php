 ...
 */
function theme_guxdi_process_css($css, $theme) {
    global $OUTPUT;
    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_guxdi_set_logo($css, $logo);
    ...
    $css = theme_guxdi_set_headerimg($css, $headerimg);
    ...
    $css = theme_guxdi_set_footerimg($css, $footerimg);
    // Set the Site color.
    ...
    $css = guxdi_set_sitecolor($css, $sitecolor);
    ...
    $css = guxdi_set_bannerfontcolor($css, $bannerfontcolor);
    ...
    $css = theme_guxdi_set_customcss($css, $customcss);
    return $css;
}
/**
 ...
 */
function theme_guxdi_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
...
function guxdi_set_sitecolor($css, $sitecolor) {
    $tag = '[[setting:sitecolor]]';
    $css = str_replace($tag, $sitecolor, $css);
    return $css;
}
function guxdi_set_bannerfontcolor($css, $bannerfontcolor) {
    $tag = '[[setting:bannerfontcolor]]';
    $css = str_replace($tag, $bannerfontcolor, $css);
    return $css;
}
function theme_guxdi_set_headerimg($css, $headerimg) {
...
function theme_guxdi_set_footerimg($css, $footerimg) {
 ...
 * @return bool
 */
function theme_guxdi_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'logo') {
        $theme = theme_config::load('guxdi');
 ...
 */
function theme_guxdi_set_customcss($css, $customcss) {
 ...
 *
 * Do not add guxdi specific logic in here, child themes should be able to
 ...
 */
function theme_guxdi_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
...
function theme_guxdi_get_setting($setting, $format = false) {
    global $CFG;
