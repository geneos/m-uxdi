...
$plugin->version   = 2017030000;  // The current module version (Date: YYYYMMDDXX).
$plugin->release = '1.0 (Build: 2017030000)';
$plugin->requires  = 2016051900; 
$plugin->component = 'theme_guxdi';
$plugin->dependencies = array(
	'theme_eduhub'  => 2016090100,
