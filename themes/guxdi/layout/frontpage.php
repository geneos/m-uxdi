...
$html = theme_guxdi_get_html_for_settings($OUTPUT, $PAGE);
...
if (!empty($PAGE->theme->settings->bannerheading)) {
    $bannerheading = theme_guxdi_get_setting('bannerheading',true);
} else {
    $bannerheading = '';
}
if (!empty($PAGE->theme->settings->bannercontent)) {
    $bannercontent = theme_guxdi_get_setting('bannercontent',true);
} else {
    $bannercontent = '';
}
...
if (!empty($PAGE->theme->settings->marketing1heading)) {
    $marketing1heading = theme_guxdi_get_setting('marketing1heading',true);
} else {
    $marketing1heading = '';
}
if (!empty($PAGE->theme->settings->marketing1subheading)) {
    $marketing1subheading = theme_guxdi_get_setting('marketing1subheading',true);
} else {
    $marketing1subheading = '';
}
if (!empty($PAGE->theme->settings->marketing1content)) {
    $marketing1content = theme_guxdi_get_setting('marketing1content',true);
} else {
    $marketing1content = '';
}
...
if (!empty($PAGE->theme->settings->marketing2heading)) {
    $marketing2heading = theme_guxdi_get_setting('marketing2heading',true);
} else {
    $marketing2heading = '';
}
if (!empty($PAGE->theme->settings->marketing2subheading)) {
    $marketing2subheading = theme_guxdi_get_setting('marketing2subheading',true);
} else {
    $marketing2subheading = '';
}
if (!empty($PAGE->theme->settings->marketing2content)) {
    $marketing2content = theme_guxdi_get_setting('marketing2content',true);
} else {
    $marketing2content = '';
}
...
if (!empty($PAGE->theme->settings->marketing3heading)) {
    $marketing3heading = theme_guxdi_get_setting('marketing3heading',true);
} else {
    $marketing3heading = '';
}
if (!empty($PAGE->theme->settings->marketing3subheading)) {
    $marketing3subheading = theme_guxdi_get_setting('marketing3subheading',true);
} else {
    $marketing3subheading = '';
}
if (!empty($PAGE->theme->settings->marketing3content)) {
    $marketing3content = theme_guxdi_get_setting('marketing3content',true);
} else {
    $marketing3content = '';
}
...
if (!empty($PAGE->theme->settings->marketing4heading)) {
    $marketing4heading = theme_guxdi_get_setting('marketing4heading',true);
} else {
    $marketing4heading = '';
}
if (!empty($PAGE->theme->settings->marketing4subheading)) {
    $marketing4subheading = theme_guxdi_get_setting('marketing4subheading',true);
} else {
    $marketing4subheading = '';
}
if (!empty($PAGE->theme->settings->marketing4content)) {
    $marketing4content = theme_guxdi_get_setting('marketing4content',true);
} else {
    $marketing4content = '';
}
...
if (!empty($PAGE->theme->settings->mainbox1heading)) {
    $mainbox1heading = theme_guxdi_get_setting('mainbox1heading',true);
} else {
    $mainbox1heading = '';
}

if (!empty($PAGE->theme->settings->mainbox1content)) {
    $mainbox1content = theme_guxdi_get_setting('mainbox1content',true);
} else {
    $mainbox1content = '';
}
...
if (!empty($PAGE->theme->settings->mainbox2heading)) {
    $mainbox2heading = theme_guxdi_get_setting('mainbox2heading',true);
} else {
    $mainbox2heading = '';
}
if (!empty($PAGE->theme->settings->mainbox2content)) {
    $mainbox2content = theme_guxdi_get_setting('mainbox2content',true);
} else {
    $mainbox2content = '';
}
...
if (!empty($PAGE->theme->settings->mainbox3heading)) {
    $mainbox3heading = theme_guxdi_get_setting('mainbox3heading',true);
} else {
    $mainbox3heading = '';
}
if (!empty($PAGE->theme->settings->mainbox3content)) {
    $mainbox3content = theme_guxdi_get_setting('mainbox3content',true);
} else {
    $mainbox3content = '';
}
...
if (!empty($PAGE->theme->settings->mainbox4heading)) {
    $mainbox4heading = theme_guxdi_get_setting('mainbox4heading',true);
} else {
    $mainbox4heading = '';
}
if (!empty($PAGE->theme->settings->mainbox4content)) {
    $mainbox4content = theme_guxdi_get_setting('mainbox4content',true);
} else {
    $mainbox4content = '';
}
...
if (!empty($PAGE->theme->settings->mainbox5icon)) {
    $mainbox5icon = $PAGE->theme->setting_file_url('mainbox5icon', 'mainbox5icon');
} else {
    $mainbox5icon = $OUTPUT->pix_url('icon5', 'theme');
}
if (!empty($PAGE->theme->settings->mainbox5heading)) {
    $mainbox5heading = theme_guxdi_get_setting('mainbox5heading',true);
} else {
    $mainbox2heading = '';
}

if (!empty($PAGE->theme->settings->mainbox5content)) {
    $mainbox5content = theme_guxdi_get_setting('mainbox5content',true);
} else {
    $mainbox5content = '';
}
if (!empty($PAGE->theme->settings->mainbox5url)) {
    $mainbox5url = $PAGE->theme->settings->mainbox5url;
} else {
    $mainbox5url = '';
}

if (!empty($PAGE->theme->settings->mainbox6icon)) {
    $mainbox6icon = $PAGE->theme->setting_file_url('mainbox6icon', 'mainbox6icon');
} else {
    $mainbox6icon = $OUTPUT->pix_url('icon8', 'theme');
}
if (!empty($PAGE->theme->settings->mainbox6heading)) {
    $mainbox6heading = theme_guxdi_get_setting('mainbox6heading',true);
} else {
    $mainbox6heading = '';
}
if (!empty($PAGE->theme->settings->mainbox6content)) {
    $mainbox6content = theme_guxdi_get_setting('mainbox6content',true);
} else {
    $mainbox6content = '';
}
if (!empty($PAGE->theme->settings->mainbox6url)) {
    $mainbox6url = $PAGE->theme->settings->mainbox6url;
} else {
    $mainbox6url = '';
}

if (!empty($PAGE->theme->settings->mainbox7icon)) {
    $mainbox7icon = $PAGE->theme->setting_file_url('mainbox7icon', 'mainbox7icon');
} else {
    $mainbox7icon = $OUTPUT->pix_url('icon8', 'theme');
}
if (!empty($PAGE->theme->settings->mainbox7heading)) {
    $mainbox7heading = theme_guxdi_get_setting('mainbox7heading',true);
} else {
    $mainbox7heading = '';
}
if (!empty($PAGE->theme->settings->mainbox7content)) {
    $mainbox7content = theme_guxdi_get_setting('mainbox7content',true);
} else {
    $mainbox7content = '';
}
if (!empty($PAGE->theme->settings->mainbox7url)) {
    $mainbox7url = $PAGE->theme->settings->mainbox7url;
} else {
    $mainbox7url = '';
}

if (!empty($PAGE->theme->settings->mainbox8icon)) {
    $mainbox8icon = $PAGE->theme->setting_file_url('mainbox8icon', 'mainbox8icon');
} else {
    $mainbox8icon = $OUTPUT->pix_url('icon8', 'theme');
}
if (!empty($PAGE->theme->settings->mainbox8heading)) {
    $mainbox8heading = theme_guxdi_get_setting('mainbox8heading',true);
} else {
    $mainbox8heading = '';
}
if (!empty($PAGE->theme->settings->mainbox8content)) {
    $mainbox8content = theme_guxdi_get_setting('mainbox8content',true);
} else {
    $mainbox8content = '';
}
if (!empty($PAGE->theme->settings->mainbox8url)) {
    $mainbox8url = $PAGE->theme->settings->mainbox8url;
} else {
    $mainbox8url = '';
}
...
if (!empty($PAGE->theme->settings->mainheading)) {
    $mainheading = theme_guxdi_get_setting('mainheading',true);
} else {
    $mainheading = '';
}
if (!empty($PAGE->theme->settings->maincontent)) {
    $maincontent = theme_guxdi_get_setting('maincontent',true);
} else {
    $maincontent = '';
}
/* Footer
...
if (!empty($PAGE->theme->settings->copyright)) {
    $hascopyright = theme_guxdi_get_setting('copyright',true);
} else {
    $hascopyright = '';
}
if (!empty($PAGE->theme->settings->getintouch)) {
    $getintouch = theme_guxdi_get_setting('getintouch',true);
} else {
    $getintouch = '';
}
if (!empty($PAGE->theme->settings->getintouchcontent)) {
    $getintouchcontent = theme_guxdi_get_setting('getintouchcontent',true);
} else {
    $getintouchcontent = '';
}
if (!empty($PAGE->theme->settings->address)) {
    $address = theme_guxdi_get_setting('address',true);
} else {
    $address = '';
}
if (!empty($PAGE->theme->settings->mobile)) {
    $mobile = theme_guxdi_get_setting('mobile',true);
} else {
    $mobile = '';
}
if (!empty($PAGE->theme->settings->mail)) {
    $mail = theme_guxdi_get_setting('mail',true);
} else {
    $mail = '';
}
if (!empty($PAGE->theme->settings->phone)) {
    $phone = theme_guxdi_get_setting('phone',true);
} else {
    $phone = '';
}
if (!empty($PAGE->theme->settings->siteheading)) {
    $siteheading = theme_guxdi_get_setting('siteheading',true);
} else {
    $siteheading = '';
}
if (!empty($PAGE->theme->settings->sitecontent)) {
    $sitecontent = theme_guxdi_get_setting('sitecontent',true);
} else {
    $sitecontent = '';
}
...
<div class="row-fluid">
   <div class="span3">
    <img src="<?php echo $mainbox5icon ?>" />
    <?php if ($mainbox5heading) { ?>
    <h1><?php echo $mainbox5heading?></h1>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>       
    <?php if ($mainbox5content) { ?>
    <p><?php echo $mainbox5content?></p>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>       
    <?php if ($mainbox5url) { ?>
    <a href="<?php echo $mainbox5url?>"><button>More</button></a>
    <?php 
    } else {
    ?>
    <?php 
   ...
   <div class="span3">
    <img src="<?php echo $mainbox6icon ?>" />
    <?php if ($mainbox6heading) { ?>
    <h1><?php echo $mainbox6heading?></h1>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>
    <?php if ($mainbox6content) { ?>
    <p><?php echo $mainbox6content?></p>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>
    <?php if ($mainbox6url) { ?>
    <a href="<?php echo $mainbox6url?>"><button>More</button></a>
    <?php 
    } else {
    ?>
    <?php 
   ...
   <div class="span3">
    <img src="<?php echo $mainbox7icon ?>" />
    <?php if ($mainbox7heading) { ?>
    <h1><?php echo $mainbox7heading?></h1>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>
    <?php if ($mainbox7content) { ?>
    <p><?php echo $mainbox7content?></p>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>
    <?php if ($mainbox7url) { ?>
    <a href="<?php echo $mainbox7url?>"><button>More</button></a>
    <?php 
    } else {
    ?>
    <?php 
   ...
   <div class="span3">
    <img src="<?php echo $mainbox8icon ?>" />
    <?php if ($mainbox8heading) { ?>
    <h1><?php echo $mainbox8heading?></h1>
    <?php 
    } else {
    ?>
    <?php 
    ...
    ?>
    <?php if ($mainbox8content) { ?>
    <p><?php echo $mainbox8content?></p>
    <?php 
    } else {
    ?>
    <?php 
